...
const REFRESH = process.argv.includes('--refresh') || process.env.OTD_POSTER_REFRESH === '1';
const APPLY_ONLY = process.argv.includes('--apply-only') || process.env.OTD_POSTER_APPLY_ONLY === '1';
