---
layout: post
title: "UFC Noche: Lopes vs. Silva | Predictions & Results"
description: "Noche UFC: Lopes vs. Silva (also known as UFC Fight Night 259,
  Noche UFC 3 and UFC on ESPN+ 117) was a mixed martial arts event produced by
  the UFC."
date: 2025-09-10
category: Breakdown
author: MMA Matlock
image:
  path: /assets/uploads/diego-lopes.png
  alt: Noche UFC Lopes vs. Silva
tags:
  - Diego Lopes
  - Jean Silva
  - UFC Noche
...
| ------------------------------------------- | -------------------------------------------------------------------------- | -------- |
| Diego Lopes via submission in Round 3 | Diego Lopes defeated Jean Silva via TKO — Round 2, 4:48 | ✅ |
| Rob Font via decision | David Martinez defeated Rob Font via unanimous decision | ❌ |
| Jared Gordon via decision | Rafa Garcia defeated Jared Gordon via TKO — Round 3, 2:27 | ❌ |
| Kelvin Gastelum via TKO in Round 2 | Kelvin Gastelum defeated Dustin Stoltzfus via unanimous decision | ✅ |
| Diego Ferreira via submission in Round 3 | Alexander Hernandez defeated Diego Ferreira via TKO — Round 2, 3:46 | ❌ |
| Santiago Luna via submission in Round 2 | Santiago Luna defeated Quang Le via KO — Round 1, 2:48 | ✅ |
| Duško Todorović via TKO in Round 1 | Duško Todorović defeated Jose Daniel Medina via submission — Round 1, 4:21 | ✅ |
| Claudio Puelles via submission in Round 2 | Joaquim Silva defeated Claudio Puelles via split decision | ❌ |
| Tatiana Suarez via decision | Tatiana Suarez defeated Amanda Lemos via unanimous decision | ✅ |
| Jesus Aguilar via submission in Round 2 | Jesus Aguilar defeated Luis Gurule via unanimous decision | ✅ |
| Zachary Reese via TKO in Round 1 | No contest due to an accidental foul — Round 1, 0:51 | ❌ |
| Alessandro Costa via TKO in Round 2 | Alden Coria defeated Alessandro Costa via TKO — Round 3, 0:47 | ❌ |
| Alice Pereira via KO in Round 1 | Montse Rendon defeated Alice Pereira via split decision | ❌ |
| Rodrigo Sezinando via submission in Round 2 | Daniil Donchenko defeated Rodrigo Sezinando via TKO — Round 1, 4:27 | ❌ |
