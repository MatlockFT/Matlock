(() => {
  ...
  const commands = [
    ...
    { key: 'stats', label: 'Stats', detail: 'Build structured head-to-head fight stats', selector: '[data-tool="stats"]', aliases: 'rows columns stats leaders' },
    { key: 'tale', label: 'Tale of Tape', detail: 'Build the structured matchup visual', selector: '[data-tool="tale"]', aliases: 'tale tape fighter matchup' },
