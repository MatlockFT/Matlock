(() => {
  ...
  app.addEventListener('pointerdown', event => {
    ...
    if (event.target.closest('[data-insert],[data-link-insert],[data-video-insert],[data-youtube-insert],[data-x-insert],[data-image-insert],[data-html-insert],[data-html-delete],[data-stats-insert],[data-tale-insert],[data-pick-insert]')) {
      pushUndo(snapshot());
