...
<script>
    ...
    function endRound(forcedWinner = null) {
        ...
        redCumulative += redRoundPoints;
        blueCumulative += blueRoundPoints;
        const roundEntry = `Round ${document.getElementById('round-select').value}: ${winner} (Cumulative: Red ${redCumulative} - Blue ${blueCumulative})`;
    ...
    function fightOver() {
        ...
        const finalEntry = `Final: Red ${redCumulative} - Blue ${blueCumulative}`;
